...
| `mason.lua`          | The list of LSP servers, formatters, linters and debug adapters Mason installs on startup               | [WhoIsSethDaniel/mason-tool-installer.nvim](https://github.com/WhoIsSethDaniel/mason-tool-installer.nvim), [williamboman/mason.nvim](https://github.com/williamboman/mason.nvim)                                |
